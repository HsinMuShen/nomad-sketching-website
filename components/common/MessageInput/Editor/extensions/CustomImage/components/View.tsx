...
type Props = {
  ...
  extension: {
    options: {
      ...
      onDelete: ({ url, sourceAbleToDelete }: { url: string; sourceAbleToDelete?: boolean }) => void;
    };
  };
  deleteNode: () => void;
...
const View = (props: Props) => {
  ...
  const handleDelete = useCallback(() => {
    ...
    onDelete({ url: src, sourceAbleToDelete });
    deleteNode();
  }, [onDelete, src, state, deleteNode, sourceAbleToDelete]);
