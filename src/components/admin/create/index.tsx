import type { MessageInputRef } from 'src/components/common/MessageInput/types'
import { useCallback, useRef } from 'react'
import Link from 'next/link'
import { useRouter } from 'next/router'
import { Button, Input } from 'src/components/common/ui'
import MessageInput from 'src/components/common/MessageInput'
import ImageUploader from 'src/components/common/ImageUploader'
import useArticle from 'src/components/admin/hooks/use-article'
