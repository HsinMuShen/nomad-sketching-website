...
export const HIDDEN_OUTLINE = 'border-transparent hover:border-transparent focus:outline-none'

export const DEFAULT_CLASSNAMES = 'bg-white color-neutral-700  hover:border-neutral-500'
